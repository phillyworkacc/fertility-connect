...
import { sendMessageToConsultant } from "../actions/consultantChat";
...
export default function ConsultantChat({ messages, userid }: ConsultantChatProps) {
   ...
   const sendMessageBtn = async () => {
      ...
      const sentMessage = await sendMessageToConsultant(messageText, userid);
      if (sentMessage) {
         setMessageText("");
      } else {
      ...
      <div className="consultant-chat">
         <div className="consultant-chat-container">
            ...
            <div className="consultant-chat-header">
               ...
               <span className="text-c-xl bold-800">Consultant Chat</span>
            </div>
            
            <BackToHome>Back to Home</BackToHome>

            <div className="text-c-xs text-center">
               Your messages are sent directly to the consultant, maintaining a secure and private one-to-one conversation.
            </div>
