...
export const ChangeEmailVerificationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Use this code to switch to your new account</Preview>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              If you want to switch to this account, use the code below to verify the change:
            </Text>
            <Text style={{ ...paragraph, fontWeight: 'bold', fontSize: '20px' }}>
              {code}
            </Text>
            <Text style={paragraph}>
